...
Welcome to ``difit`` contributor's guide.
...
If you experience bugs or general issues with ``difit``, please have a look
...
You can help improve ``difit`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``difit`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``difit``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/difit.git
    cd difit
...
#. Install |pre-commit|_::
   ...
   ``difit`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/difit
.. _issue tracker: https://github.com/<USERNAME>/difit/issues
.. <-- end -->
